-- Migration: 008_seed_development
-- Description: Development seed data for testing — safe to skip in production
-- On Supabase: run this only if you want sample properties/users to explore the app.
-- To skip: simply don't run this file. Migrations 001-007 and 009 are all you need to go live.
